	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				...
				<li>
					<a class="page-scroll" href="#loginPart">Login</a>
				</li>
				<li>
...
<!-- login Grid Section -->
<section id="loginPart" class="bg-light-gray">
	<div class="container">
		<div class="row">
				...
				<div id='login'>
					<div class='header text-center'>
						...
						<form action='${postUrl}' method='POST' id='loginForm' class='cssform' autocomplete='off'>
							...
							<p>
								<input type='submit' id="submit" class="btn btn-xl" value='${message(code: "springSecurity.login.button")}'/>
							</p>
						</form>
					</div>
				</div>
...
<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<span class="copyright">Copyright &copy; Mtb Website 2016</span>
			</div>
			<div class="col-md-4">
